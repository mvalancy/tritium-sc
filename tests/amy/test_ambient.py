...
from amy.simulation.ambient import (
    AmbientSpawner,
    _CAR_NAMES,
    _CAT_NAMES,
    _DELIVERY_NAMES,
...
from amy.simulation.target import SimulationTarget, _DRAIN_RATES
...
class TestStreetGrid:
    ...
    def test_street_path_returns_two_waypoints(self) -> None:
        from amy.simulation.ambient import _street_path
    ...
    def test_street_path_corner_near_street(self) -> None:
        ...
        from amy.simulation.ambient import _street_path, _STREETS_NS_X, _STREET_JITTER
    ...
    def test_snap_to_nearest_street(self) -> None:
        from amy.simulation.ambient import _snap_to_nearest_street, _STREETS_NS_X, _STREETS_EW_Y, _STREET_JITTER
    ...
    def test_sidewalk_path_follows_streets(self, spawner: AmbientSpawner) -> None:
        ...
        from amy.simulation.ambient import _STREETS_NS_X, _STREET_JITTER
        corner_x = path[0][0]
        min_dist = min(abs(corner_x - sx) for sx in _STREETS_NS_X)
        assert min_dist <= _STREET_JITTER + 0.01
...
class TestTimeOfDay:
    ...
    def test_hour_activity_returns_tuple(self) -> None:
        from amy.simulation.ambient import _hour_activity
    ...
    def test_daytime_high_ambient(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        from amy.simulation import ambient as amb_mod
